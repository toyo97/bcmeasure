...
def calculate_slices(stack, zc, dim):
...
class CellStack(VirtualStack):
    def __init__(self, stack, xc, yc, zc, dim):
        # type: (ImageStack, int, int, int, int) -> CellStack
        """
Constructor of the VirtualStack pointing to the cell at the given coordinates
        ...
        :param dim: Dimension of the cube roi around the cell
        """
        self.z_start, size = calculate_slices(stack, zc, dim)
